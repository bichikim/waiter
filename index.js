    ...
    _createClass(Waiter, [{
        ...
        value: function execute(options) {
            ...
            var returnObject = {},
                ...
                var bindAndArguments = _this._getBindAndArgument(value, options);
        ...
        key: '_getBindAndArgument',
        value: function _getBindAndArgument(value, options) {
            var myArguments = null,
                myBind = null;
            if (_lodash2.default.isObject(options)) {
                myArguments = this._pickArguments(_lodash2.default.isArray(value.argument) ? value.argument : null, _lodash2.default.isArray(options.arguments) ? options.arguments : null, _lodash2.default.isArray(options.additionalArguments) ? options.additionalArguments : null);
        ...
        value: function executeAsync(options, resultCallback, errorCallback) {
            ...
            var async = async function async() {
                ...
                _lodash2.default.forEach(_this2._callbacks, function (callback, key) {
                    //If It should execute by option.
                    if (_this2._isExecute(options, callback.name)) {
                        ...
                        if (refresh) {
                            var bindAndArguments = _this2._getBindAndArgument(callback, options[callback.name]);
            ...
            if (_lodash2.default.isFunction(errorCallback)) {
                afterAsync.catch(function (reason) {
