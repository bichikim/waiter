...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //noinspection JSUnresolvedVariable
...
var Waiter = function () {
    ...
    _createClass(Waiter, [{
        ...
        value: function execute(option) {
            ...
            var isOption = _lodash2.default.isObject(option),
                returnObject = {};

            //모든 함수 실행
            _lodash2.default.forEach(this._callbacks, function (value) {
                var doExecute = false;
                if (isOption) {
                    if (!_lodash2.default.isNil(option[value.name]) && option[value.name].operate) {
                        doExecute = true;
                    } else if (_lodash2.default.isNil(option[value.name])) {
                ...
                if (doExecute) {
                    returnObject[value.name] = this._executeOne(value, _lodash2.default.isNil(option[value.name]) ? [] : option[value.name]);
                }
                return true;
            }.bind(this));
        ...
        key: '_executeOne',
        value: function _executeOne(value, option) {
            ...
            if (_lodash2.default.isObject(value.bind)) {
                _lodash2.default.forEach(value.bind, function (value, name) {
                    myBind[name] = value;
                });
            }

            if (_lodash2.default.isObject(option.bind)) {
                _lodash2.default.forEach(option.bind, function (value, name) {
                    myBind[name] = value;
                });
            }

            if (_lodash2.default.isArray(option.arguments)) {
                myArgument = option.arguments;
            } else if (_lodash2.default.isArray(value.argument)) {
                myArgument = value.argument;
            } else {
                myArgument = this._arguments;
            }

            if (_lodash2.default.isArray(option.additionalArguments)) {
                myArgument = _lodash2.default.union(myArgument, option.additionalArguments);
            }
        ...
        value: function saveMany(objects) {
            ...
            _lodash2.default.forEach(objects, function (value, key) {
                ...
                this.save(value.callback, key, value.ones, value.bind, value.argument);
            }.bind(this));
            return true;
        }
        ...
        key: 'save',
        value: function save(callback, name, ones, my_bind_object, my_argument_object) {
            ...
            this._callbacks.push({
                ...
                argument: _lodash2.default.isObject(my_argument_object) ? my_argument_object : null
            });
            return true;
        }
